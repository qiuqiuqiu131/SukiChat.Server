...
namespace ChatServer.DataBase.Migrations
{
    ...
    [Migration("20250330072851_ChatDetail1")]
    partial class ChatDetail1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatServer.DataBase.DataBase.DataEntity.ChatGroupDetail", b =>
                {
            ...
            modelBuilder.Entity("ChatServer.DataBase.DataBase.DataEntity.ChatPrivateDetail", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("varchar(10)");
                    ...
                    b.HasIndex("ChatPrivateId");

                    b.ToTable("ChatPrivateDetails");
                });
            ...
            modelBuilder.Entity("ChatServer.DataBase.DataBase.DataEntity.User", b =>
                {
                    ...
                    b.Property<DateTime>("LastDeleteFriendMessageTime")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime>("LastDeleteGroupMessageTime")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime>("LastReadFriendMessageTime")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime>("LastReadGroupMessageTime")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("ChatServer.DataBase.DataBase.DataEntity.ChatGroupDetail", b =>
                {
                    b.HasOne("ChatServer.DataBase.DataBase.DataEntity.ChatGroup", "ChatGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatServer.DataBase.DataBase.DataEntity.ChatPrivateDetail", b =>
                {
                    b.HasOne("ChatServer.DataBase.DataBase.DataEntity.ChatPrivate", "ChatPrivate")
                        .WithMany()
                        .HasForeignKey("ChatPrivateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
